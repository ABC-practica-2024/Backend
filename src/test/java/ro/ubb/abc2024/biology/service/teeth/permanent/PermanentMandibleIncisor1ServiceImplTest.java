...
class PermanentMandibleIncisor1ServiceImplTest {

    @Mock
    private JpaRepository<PermanentMandibleIncisor1, Long> repository;

    @Mock
    private PermanentMandibleIncisor1Mapper mapper;

    @InjectMocks
    private PermanentMandibleIncisor1ServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMandibleIncisor1Dto dto = new PermanentMandibleIncisor1Dto();
        PermanentMandibleIncisor1 entity = new PermanentMandibleIncisor1();
        ...
        PermanentMandibleIncisor1 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMandibleIncisor1Dto dto = new PermanentMandibleIncisor1Dto();
        PermanentMandibleIncisor1 existingEntity = new PermanentMandibleIncisor1();
        ...
        // Call the method under test
        PermanentMandibleIncisor1 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMandibleIncisor1 result = service.getById(id);
