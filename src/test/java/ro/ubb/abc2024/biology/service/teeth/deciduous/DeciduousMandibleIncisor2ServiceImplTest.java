...
class DeciduousMandibleIncisor2ServiceImplTest {

    @Mock
    private JpaRepository<DeciduousMandibleIncisor2, Long> repository;

    @Mock
    private DeciduousMandibleIncisor2Mapper mapper;

    @InjectMocks
    private DeciduousMandibleIncisor2ServiceImpl service;
    ...
    @Test
    void testSave() {
        DeciduousMandibleIncisor2Dto dto = new DeciduousMandibleIncisor2Dto();
        DeciduousMandibleIncisor2 entity = new DeciduousMandibleIncisor2();
        ...
        DeciduousMandibleIncisor2 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        DeciduousMandibleIncisor2Dto dto = new DeciduousMandibleIncisor2Dto();
        DeciduousMandibleIncisor2 existingEntity = new DeciduousMandibleIncisor2();
        ...
        // Call the method under test
        DeciduousMandibleIncisor2 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        DeciduousMandibleIncisor2 result = service.getById(id);
