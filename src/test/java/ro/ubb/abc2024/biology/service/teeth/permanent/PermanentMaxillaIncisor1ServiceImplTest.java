...
class PermanentMaxillaIncisor1ServiceImplTest {

    @Mock
    private JpaRepository<PermanentMaxillaIncisor1, Long> repository;

    @Mock
    private PermanentMaxillaIncisor1Mapper mapper;

    @InjectMocks
    private PermanentMaxillaIncisor1ServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMaxillaIncisor1Dto dto = PermanentMaxillaIncisor1Dto.builder().build();
        PermanentMaxillaIncisor1 entity = new PermanentMaxillaIncisor1();
        ...
        PermanentMaxillaIncisor1 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMaxillaIncisor1Dto dto = PermanentMaxillaIncisor1Dto.builder().build();
        PermanentMaxillaIncisor1 existingEntity = new PermanentMaxillaIncisor1();
        ...
        // Call the method under test
        PermanentMaxillaIncisor1 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMaxillaIncisor1 result = service.getById(id);
