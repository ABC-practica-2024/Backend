...
class PermanentMaxillaIncisor2ServiceImplTest {

    @Mock
    private JpaRepository<PermanentMaxillaIncisor2, Long> repository;

    @Mock
    private PermanentMaxillaIncisor2Mapper mapper;

    @InjectMocks
    private PermanentMaxillaIncisor2ServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMaxillaIncisor2Dto dto = PermanentMaxillaIncisor2Dto.builder().build();
        PermanentMaxillaIncisor2 entity = new PermanentMaxillaIncisor2();
        ...
        PermanentMaxillaIncisor2 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMaxillaIncisor2Dto dto = PermanentMaxillaIncisor2Dto.builder().build();
        PermanentMaxillaIncisor2 existingEntity = new PermanentMaxillaIncisor2();
        ...
        // Call the method under test
        PermanentMaxillaIncisor2 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMaxillaIncisor2 result = service.getById(id);
