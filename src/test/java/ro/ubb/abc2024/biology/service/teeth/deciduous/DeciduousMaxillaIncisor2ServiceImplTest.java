...
class DeciduousMaxillaIncisor2ServiceImplTest {

    @Mock
    private JpaRepository<DeciduousMaxillaIncisor2, Long> repository;

    @Mock
    private DeciduousMaxillaIncisor2Mapper mapper;

    @InjectMocks
    private DeciduousMaxillaIncisor2ServiceImpl service;
    ...
    @Test
    void testSave() {
        DeciduousMaxillaIncisor2Dto dto = new DeciduousMaxillaIncisor2Dto();
        DeciduousMaxillaIncisor2 entity = new DeciduousMaxillaIncisor2();
        ...
        DeciduousMaxillaIncisor2 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        DeciduousMaxillaIncisor2Dto dto = new DeciduousMaxillaIncisor2Dto();
        DeciduousMaxillaIncisor2 existingEntity = new DeciduousMaxillaIncisor2();
        ...
        // Call the method under test
        DeciduousMaxillaIncisor2 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        DeciduousMaxillaIncisor2 result = service.getById(id);
