...
class PermanentMaxillaMolar3ServiceImplTest {
    ...
    @InjectMocks
    private PermanentMaxillaMolar3ServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMaxillaMolar3Dto dto = new PermanentMaxillaMolar3Dto();
        PermanentMaxillaMolar3 entity = new PermanentMaxillaMolar3();
        ...
        PermanentMaxillaMolar3 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMaxillaMolar3Dto dto = new PermanentMaxillaMolar3Dto();
        PermanentMaxillaMolar3 existingEntity = new PermanentMaxillaMolar3();
        ...
        // Call the method under test
        PermanentMaxillaMolar3 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMaxillaMolar3 result = service.getById(id);
