...
class PermanentMaxillaMolar1ServiceImplTest {

    @Mock
    private JpaRepository<PermanentMaxillaMolar1, Long> repository;

    @Mock
    private PermanentMaxillaMolar1Mapper mapper;

    @InjectMocks
    private PermanentMaxillaMolar1ServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMaxillaMolar1Dto dto = new PermanentMaxillaMolar1Dto();
        PermanentMaxillaMolar1 entity = new PermanentMaxillaMolar1();
        ...
        PermanentMaxillaMolar1 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMaxillaMolar1Dto dto = new PermanentMaxillaMolar1Dto();
        PermanentMaxillaMolar1 existingEntity = new PermanentMaxillaMolar1();
        ...
        // Call the method under test
        PermanentMaxillaMolar1 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMaxillaMolar1 result = service.getById(id);
