...
class PermanentMandibleIncisor2ServiceImplTest {
    ...
    @InjectMocks
    private PermanentMandibleIncisor2ServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMandibleIncisor2Dto dto = new PermanentMandibleIncisor2Dto();
        PermanentMandibleIncisor2 entity = new PermanentMandibleIncisor2();
        ...
        PermanentMandibleIncisor2 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMandibleIncisor2Dto dto = new PermanentMandibleIncisor2Dto();
        PermanentMandibleIncisor2 existingEntity = new PermanentMandibleIncisor2();
        ...
        // Call the method under test
        PermanentMandibleIncisor2 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMandibleIncisor2 result = service.getById(id);
