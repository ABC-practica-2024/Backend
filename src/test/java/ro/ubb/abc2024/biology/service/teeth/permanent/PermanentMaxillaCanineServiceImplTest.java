...
class PermanentMaxillaCanineServiceImplTest {

    @Mock
    private JpaRepository<PermanentMaxillaCanine, Long> repository;

    @Mock
    private PermanentMaxillaCanineMapper mapper;

    @InjectMocks
    private PermanentMaxillaCanineServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMaxillaCanineDto dto = PermanentMaxillaCanineDto.builder().build();
        PermanentMaxillaCanine entity = new PermanentMaxillaCanine();
        ...
        PermanentMaxillaCanine result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMaxillaCanineDto dto = PermanentMaxillaCanineDto.builder().build();
        PermanentMaxillaCanine existingEntity = new PermanentMaxillaCanine();
        ...
        // Call the method under test
        PermanentMaxillaCanine result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMaxillaCanine result = service.getById(id);
