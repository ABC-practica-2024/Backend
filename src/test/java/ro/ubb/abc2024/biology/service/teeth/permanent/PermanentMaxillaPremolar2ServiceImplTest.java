...
class PermanentMaxillaPremolar2ServiceImplTest {

    @Mock
    private JpaRepository<PermanentMaxillaPremolar2, Long> repository;

    @Mock
    private PermanentMaxillaPremolar2Mapper mapper;

    @InjectMocks
    private PermanentMaxillaPremolar2ServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMaxillaPremolar2Dto dto = new PermanentMaxillaPremolar2Dto();
        PermanentMaxillaPremolar2 entity = new PermanentMaxillaPremolar2();
        ...
        PermanentMaxillaPremolar2 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMaxillaPremolar2Dto dto = new PermanentMaxillaPremolar2Dto();
        PermanentMaxillaPremolar2 existingEntity = new PermanentMaxillaPremolar2();
        ...
        // Call the method under test
        PermanentMaxillaPremolar2 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMaxillaPremolar2 result = service.getById(id);
