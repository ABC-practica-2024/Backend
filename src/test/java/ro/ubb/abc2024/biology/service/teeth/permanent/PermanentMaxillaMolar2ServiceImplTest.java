...
class PermanentMaxillaMolar2ServiceImplTest {

    @Mock
    private JpaRepository<PermanentMaxillaMolar2, Long> repository;

    @Mock
    private PermanentMaxillaMolar2Mapper mapper;

    @InjectMocks
    private PermanentMaxillaMolar2ServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMaxillaMolar2Dto dto = new PermanentMaxillaMolar2Dto();
        PermanentMaxillaMolar2 entity = new PermanentMaxillaMolar2();
        ...
        PermanentMaxillaMolar2 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMaxillaMolar2Dto dto = new PermanentMaxillaMolar2Dto();
        PermanentMaxillaMolar2 existingEntity = new PermanentMaxillaMolar2();
        ...
        // Call the method under test
        PermanentMaxillaMolar2 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMaxillaMolar2 result = service.getById(id);
