...
class PermanentMandiblePremolar2ServiceImplTest {

    @Mock
    private JpaRepository<PermanentMandiblePremolar2, Long> repository;

    @Mock
    private PermanentMandiblePremolar2Mapper mapper;

    @InjectMocks
    private PermanentMandiblePremolar2ServiceImpl service;
    ...
    @Test
    void testSave() {
        PermanentMandiblePremolar2Dto dto = PermanentMandiblePremolar2Dto.builder().build();
        PermanentMandiblePremolar2 entity = new PermanentMandiblePremolar2();
        ...
        PermanentMandiblePremolar2 result = service.save(dto);
    ...
    void testUpdate() {
        Long id = 1L;
        PermanentMandiblePremolar2Dto dto = PermanentMandiblePremolar2Dto.builder().build();
        PermanentMandiblePremolar2 existingEntity = new PermanentMandiblePremolar2();
        ...
        // Call the method under test
        PermanentMandiblePremolar2 result = service.update(id, dto);
    ...
    void testGetById() {
        ...
        // Call the method under test
        PermanentMandiblePremolar2 result = service.getById(id);
